...
const Home = ({ setSelectedPage }: Props) => {
  ...
  return (
    <section id={SelectedPage.Home} className="gap-16 bg-gray-20 py-10 md:h-full md:pb-0">
      ...
      >
        {/* MAIN HEADER */}
        <div className="z-10 mt-32 md:basis-3/5 selection:">
          {/* HEADINGS */}
          <motion.div
            className="md:-mt-20"
            initial="hidden"
          ...
          >
            ...
            <p className="mt-8 text-sm">
              Unrivaled Gym. Unparalleled Training Fitness Classes. World Class Studios to ge the Body Shapes That you
              Dream of.. Get you Dream Body Now.
            </p>
          </motion.div>
